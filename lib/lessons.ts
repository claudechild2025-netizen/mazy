...
export const LESSONS: Lesson[] = [
  ...
  {
    id: 'lenses',
    title_mn: 'Бөмбөлөг толь ба линз',
    blurb_mn: 'Хүнхэр, гүдгэр толь ба фокусын зарчим.',
    minutes: 6,
    steps: 3,
    xp: 35,
    lab: 'spherical-mirror',
    learnings_mn: [
      'Хүнхэр ба гүдгэр толь — ялгаа, хэрэглээ',
      'Фокусын цэг (F), муруйлтын төв (C)',
      'Бөмбөлөг толины томьёо: 1/a + 1/b = 1/f',
    ],
  },
  {
    id: 'prism',
...
export const STEPS_BY_LESSON: Record<string, LessonStep[]> = {
  ...
  refraction: [
    {
      id: 1,
      title_mn: 'Гэрэл орчин дамжихад',
      body_mn:
        'Гэрэл агаараас усанд орохдоо хурд нь буурч, чиглэл нь хугардаг. Үүнийг хугарал гэнэ.',
      visual: 'refraction',
    },
    {
      id: 2,
      ...
      body_mn:
        'n₁·sin θ₁ = n₂·sin θ₂. Энд n нь орчны хугарлын илтгэлцүүр (вакуумд n=1, усанд n≈1.33).',
      visual: 'refraction',
    },
    {
      id: 3,
      title_mn: 'Бүрэн дотоод ойлт',
      body_mn:
        'Усан доороос дээш гарах гэрэл тодорхой өнцгөөс хэтрэхэд гадагш гарахаа больж, эргэж ойдог.',
      visual: 'refraction',
    },
  ],
  lenses: [
    {
      id: 1,
      title_mn: 'Хүнхэр ба гүдгэр толь',
      body_mn:
        'Бөмбөлгийн дотор тал нь дүрс үүсгэвэл хүнхэр, гадна тал нь үүсгэвэл гүдгэр толь гэнэ. Машины ар тал толь, дэлгүүрийн булангийн толь — гүдгэр.',
      visual: 'lens',
      lab: 'spherical-mirror',
    },
    {
      id: 2,
      title_mn: 'Фокусын цэг',
      body_mn:
        'Гол оптик тэнхлэгтэй параллел туссан гэрэл хүнхэр толинд ойж нэг цэгт цуглардаг — энэ нь фокусын цэг (F).',
      visual: 'lens',
    },
    {
      id: 3,
      title_mn: 'Бөмбөлөг толины томьёо',
      body_mn:
        '1/a + 1/b = 1/f. a — биеэс толь хүртэлх зай, b — дүрсээс толь хүртэлх зай, f — фокусын зай.',
      visual: 'lens',
    },
  ],
  prism: [
    {
      id: 1,
      title_mn: 'Цагаан гэрэл — нийлбэр өнгө',
      body_mn:
        'Нарны цагаан гэрэл нь нэг өнгө биш. Улаан, улбар шар, шар, ногоон, цэнхэр, хөх, ягаан — 7 өнгөний нийлбэр.',
      visual: 'refraction',
    },
    {
      id: 2,
      title_mn: 'Призмээр задрах',
      body_mn:
    ...
    {
      id: 3,
      title_mn: 'Солонго — байгалийн призм',
      body_mn:
        'Бороотой агаар дахь ус дусал бүр жижиг призм адил ажилладаг. Ийнхүү нарны гэрэл 7 өнгөнд задарч солонго харагдана.',
      visual: 'refraction',
    },
  ],
};
...
export const QUIZ_BY_LESSON: Record<string, QuizItem[]> = {
  reflection: [
    ...
    },
    {
      kind: 'mcq',
      id: 'q3',
      prompt_mn: 'Гэрлийн ойлтын хууль аль гадаргуунд үйлчлэх вэ?',
      options: [
        { key: 'a', text_mn: 'Зөвхөн хавтгай толинд' },
        { key: 'b', text_mn: 'Гэрэл ойлгож чадах бүх гадаргуунд' },
        { key: 'c', text_mn: 'Зөвхөн металл гадаргуунд' },
        { key: 'd', text_mn: 'Зөвхөн усны гадаргуунд' },
      ],
      correct_key: 'b',
    },
  ],
  ...
  refraction: [
    {
      kind: 'mcq',
      id: 'q1',
      prompt_mn: 'Снеллийн хуулийг илэрхийлэх зөв томьёо аль нь вэ?',
      options: [
  ...
  lenses: [
    {
      ...
      id: 'q1',
      prompt_mn:
        'Хүнхэр толинд параллел туссан цацраг ойсныхоо дараа хаагуур очих вэ?',
      options: [
        { key: 'a', text_mn: 'Параллел чигтээ үлдэнэ' },
        { key: 'b', text_mn: 'Фокусын цэгийг (F) дайрна' },
        { key: 'c', text_mn: 'Муруйлтын төвийг (C) дайрна' },
        { key: 'd', text_mn: 'Буцаад өөрийн зам руугаа очно' },
      ],
      correct_key: 'b',
    },
    {
      kind: 'mcq',
      id: 'q2',
      prompt_mn: 'Бөмбөлөг толины томьёо аль нь вэ?',
      options: [
        { key: 'a', text_mn: 'a + b = f' },
        { key: 'b', text_mn: '1/a + 1/b = 1/f' },
        { key: 'c', text_mn: 'a · b = f²' },
        { key: 'd', text_mn: '1/a − 1/b = 2/R' },
      ],
      correct_key: 'b',
    },
    {
      kind: 'mcq',
      id: 'q3',
      prompt_mn: 'Машины ар талын толь ямар толь вэ?',
      options: [
        { key: 'a', text_mn: 'Хавтгай толь' },
        { key: 'b', text_mn: 'Хүнхэр толь' },
        { key: 'c', text_mn: 'Гүдгэр толь' },
        { key: 'd', text_mn: 'Призм' },
      ],
      correct_key: 'c',
    },
  ...
  prism: [
    {
      kind: 'mcq',
      id: 'q1',
      prompt_mn: 'Цагаан гэрлийг призмээр нэвтрүүлбэл юу болох вэ?',
      options: [
        { key: 'a', text_mn: 'Гэрэл унтарна' },
        { key: 'b', text_mn: 'Цагаанаар үлдэнэ' },
        { key: 'c', text_mn: '7 өнгөнд задарна' },
        { key: 'd', text_mn: 'Хар өнгө болно' },
      ],
      correct_key: 'c',
    },
    {
      kind: 'mcq',
      id: 'q2',
      prompt_mn: 'Дисперс гэж юу вэ?',
      options: [
        { key: 'a', text_mn: 'Гэрэл хурдыг алдах үзэгдэл' },
        { key: 'b', text_mn: 'Гэрэл өнгөнд задрах үзэгдэл' },
        { key: 'c', text_mn: 'Гэрэл толинд ойх үзэгдэл' },
        { key: 'd', text_mn: 'Хоёр гэрэл нэгдэх үзэгдэл' },
      ],
      correct_key: 'b',
    },
    {
      kind: 'mcq',
      id: 'q3',
      prompt_mn: 'Солонго юунаас үүсдэг вэ?',
      options: [
        { key: 'a', text_mn: 'Үүл нийлж нар гарахаас' },
        { key: 'b', text_mn: 'Усны дусал нарны гэрлийг задалснаас' },
        { key: 'c', text_mn: 'Сар Дэлхийн сүүдэрт орсноос' },
        { key: 'd', text_mn: 'Хүйтэн агаар бүхээглэхээс' },
      ],
      correct_key: 'b',
    },
  ],
