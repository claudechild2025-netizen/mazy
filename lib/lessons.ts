...
export const STEPS_BY_LESSON: Record<string, LessonStep[]> = {
  ...
  prism: [
    {
      id: 1,
      title_mn: 'Цагаан гэрлийн нууц',
      body_mn:
        'Нарны цагаан гэрэл бол нэг өнгө биш — улаан, улбар шар, шар, ногоон, цэнхэр, хөх, ягаан гэсэн 7 өнгөний нийлбэр юм.',
      visual: 'refraction',
    },
    {
      id: 2,
      ...
      body_mn:
        'Гэрэл шилэн призмээр дамжихдаа өнгө бүр өөр өнцгөөр хугардаг учраас өнгө салангид гарч ирнэ. Үүнийг дисперс гэнэ.',
      visual: 'refraction',
    },
    {
      id: 3,
      title_mn: 'Солонго',
      body_mn:
        'Бороотой агаарт ус дусал бүр жижиг призм мэт ажиллаж нарны гэрлийг 7 өнгөнд задалснаар бид солонго хардаг.',
      visual: 'refraction',
    },
  ],
};
...
export const QUIZ_BY_LESSON: Record<string, QuizItem[]> = {
  ...
  lenses: [
    {
      ...
      id: 'q1',
      prompt_mn:
        'Хүнхэр толинд гол оптик тэнхлэгтэй параллел тусаад ойсон цацраг хааш хөдлөх вэ?',
      options: [
        { key: 'a', text_mn: 'Тэнхлэгтэй параллел үлдэнэ' },
        { key: 'b', text_mn: 'Фокусын цэг (F) дайрна' },
        { key: 'c', text_mn: 'Муруйлтын төв (C) дайрна' },
        { key: 'd', text_mn: 'Буцаад өөрөө очно' },
      ],
      correct_key: 'b',
    },
    {
  ...
  prism: [
    ...
    },
    {
      kind: 'mcq',
      id: 'q3',
      prompt_mn: 'Солонго хэрхэн үүсдэг вэ?',
      options: [
        { key: 'a', text_mn: 'Үүлс хоорондоо мөргөлдөж' },
        { key: 'b', text_mn: 'Усны дусал нар гэрлийг задалсанаас' },
        { key: 'c', text_mn: 'Сар Дэлхийн сүүдэрт орсноос' },
        { key: 'd', text_mn: 'Агаар халцрахаас' },
      ],
      correct_key: 'b',
    },
  ],
